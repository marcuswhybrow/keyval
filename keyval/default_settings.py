...
# Currently configured as an sqlite3 database, for more specific
# implementations override these values in local_settings.py
DATABASES = {
    'default': {
...
# SECRET_KEY = '...'
# The secret key must be specified in local_settings.py
